...
const Topbar = ({ setMobileOpen, adminProfile, avatarUrl }) => {
  ...
  return (
    <div className="h-16 flex items-center justify-between px-6 lg:px-8 bg-white/80 backdrop-blur-xl border-b border-slate-200 sticky top-0 z-40 shadow-sm">
      ...
      <div className="flex items-center gap-4 lg:gap-6">
        <div className="hidden md:flex items-center bg-slate-50 px-4 py-2 rounded-none border border-slate-200/50 group focus-within:bg-white focus-within:ring-2 focus-within:ring-indigo-100 transition-all">
        ...
        <div className="relative cursor-pointer hover:scale-110 transition-transform active:scale-90">
            <Bell className="text-slate-400 hover:text-indigo-600 transition-colors" size={18} />
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-slate-200">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-wider mt-1">Super Admin</p>
          </div>
          <img 
            src={avatarUrl} 
            alt="Admin"
