...
const InstructorProfileSettings = () => { 
    ...
    useEffect(() => {
        if (instructorProfile) {
            ...
            if (instructorProfile.avatar) {
                ...
                setAvatarPreview(`http://localhost:8000/${instructorProfile.avatar.replace(/\\/g, "/")}`);
            }
        }
    }, [instructorProfile]);
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto mt-6 border border-gray-100">
            <h2 className="text-2xl font-bold mb-6 text-gray-800 border-b pb-4">Instructor Profile Settings</h2>
                ...
                <div className="flex flex-col md:flex-row gap-10 items-start">
                    ...
                    <div className="flex flex-col items-center space-y-4 w-full md:w-1/3 pt-2">
                        <div className="relative group">
                            ...
                            />
                            <label htmlFor="avatar-upload" className="absolute bottom-2 right-2 bg-purple-600 p-2.5 rounded-full text-white cursor-pointer hover:bg-purple-700 transition shadow-md hover:scale-105">
                                <Camera size={20} />
                            </label>
